    ...
    public partial class TorneoCRUD : Form
    {
        ...
        private void editar_Click(object sender, EventArgs e)
        {
          ...
          Torneo tr=  trcontext.Gettorneo(id);
            ...
            cmbjugadores.Text = Convert.ToString(tr.Tipo_de_Campo);
