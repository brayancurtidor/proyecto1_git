...
namespace Administracion_Torneos.Vista
{
    public partial class jugadorescrud : Form
    {
        ...
        private void Guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se puede realizar la operacion","ALERTA",MessageBoxButtons.OK,MessageBoxIcon.Information);
            }
            else
            {
        ...
        {
            //validacion para que solo se ingrese un tipo de datos
        ...
        {
            //validacion para ingresar solo un tipo de datos
            if ((e.KeyChar >= 32 && e.KeyChar <= 47) || (e.KeyChar >= 58 && e.KeyChar <= 255))
            {
                MessageBox.Show("Agregar solo numeros", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
